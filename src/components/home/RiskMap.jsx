...
// ✅ Komponen helper — harus di luar RiskMap
...
export default function RiskMap({ center, weatherData, metadata, userJob = "nelayan" }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow p-4 space-y-3">
      ...
      {/* ✅ Hapus key, biarkan MapContainer tetap hidup */}
      <MapContainer center={center} zoom={14} className="h-[400px] rounded-xl z-0">
        <TileLayer
          attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
          url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
        />
        {/* ✅ MapController mengurus pindah view + buka popup */}
